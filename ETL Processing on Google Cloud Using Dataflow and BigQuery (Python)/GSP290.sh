...
mv abhi.sh dataflow-python-examples/

docker run -it -e PROJECT=$PROJECT -e REGION=$REGION -v $(pwd)/dataflow-python-examples:/dataflow python:3.8 /bin/bash /dataflow/abhi.sh
